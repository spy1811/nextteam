...
const axios = require('axios'); 
  ...
  export const fetchDistribution = createAsyncThunk('fetchDistribution', async () => {
    const response = await axios.get('http://54.176.140.51/api/distribution_header');
  ...
  export const addDistribution = createAsyncThunk('addDistribution', async (data) => 
  {
      ...
      const response = await axios.post('http://54.176.140.51/api/distribution_header', formData, {
                      headers: {
  ...
  export const addDistributionLine = createAsyncThunk('addDistributionLine', async (data) => 
  {
      ...
      const response = await axios.post('http://54.176.140.51/api/distribution_lines', formData, {
                      headers: {
                          'Content-Type': 'multipart/form-data',
                      },
                  });
  ...
  export const fetchDistributionId = createAsyncThunk('fetchDistributionId',async (id)=>{
    const response = await axios.get('http://54.176.140.51/api/distribution_header/'+id);
    return response.data;
  });


  export const fetchDistributionListId = createAsyncThunk('fetchDistributionListId',async (id)=>{
    const response = await axios.get('http://54.176.140.51/api/distribution_lines/'+id);
    return response.data;
  });
  ...
  export const EditPlan = createAsyncThunk('EditPlan',async (data)=>{
    ...
    const response = await axios.post('http://54.176.140.51/api/distribution_lines/'+data.distributionId,formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                    },
                });
  ...
  export const deleteDistributionHeader = createAsyncThunk('deleteDistributionHeader',async (id)=>{
    const response = await axios.delete('http://54.176.140.51/api/distribution_header/'+id);
    return response.data;
  });
  ...
  export const fetchVehicle = createAsyncThunk('fetchVehicle', async () => {
    const response = await axios.get('http://54.176.140.51/api/vehiclefleet');
  ...
  export const fetchTruckCategory = createAsyncThunk('fetchTruckCategory', async () => {
    const response = await axios.get('http://54.176.140.51/api/truckcategory');
    return response.data;
  });
  ...
  export const addImport = createAsyncThunk('addImport', async (data) => 
  {
      ...
      const response = await axios.post('http://54.176.140.51/api/import', formData, {
                      headers: {
                          'Content-Type': 'multipart/form-data',
                      },
                  });
...
//   });
  ...
  export const addPlan = createAsyncThunk('addPlan',async (data)=>{
    ...
    const response = await axios.post('http://54.176.140.51/api/distribution_header/'+data.distributionId,formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                    },
                });
  ...
  export const addMap = createAsyncThunk('addMap', async (data) => 
  {
      ...
      const response = await axios.post('http://54.176.140.51/api/mapping', formData, {
                      headers: {
                          'Content-Type': 'multipart/form-data',
                      },
                  });
